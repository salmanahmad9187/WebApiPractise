...
namespace Resolver
{
    ...
    {
        public static void LoadContainer(IUnityContainer container, string path, string pattren)
        {
            var dirCat = new DirectoryCatalog(path, pattren);
    ...
    internal class RegisterComponent : IRegisterComponent
    {
        ...
        {
            this._container.RegisterInstance<TInterface>(instance);
        }
